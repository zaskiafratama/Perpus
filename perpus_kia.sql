...
(1, 7, 'dilan', 'dilan', 'kia', '1995', 'sangat bagus');
...
(4, 'siswa 1', 'peminjam', '55f3894bc5fc71fead8412d321c2952c', 'peminjam@gmail.com', 'batujajar', '082117693350', 'peminjam'),
(5, 'admin1', 'admin1', 'e00cf25ad42683b3df678c61f42c6bda', 'admin1@gmail.com', 'batujajar', '09876756', 'admin'),
(6, 'petugas1', 'petugas1', 'b53fe7751b37e40ff34d012c7774d65f', 'petugas1@gmail.com', 'batujajar', '084738219472', 'petugas'),
(7, 'Zaskia fratama', 'peminjam', 'peminjam', 'peminjam@gmal.com', 'batujajar', NULL, 'peminjam');
...
ALTER TABLE `buku`
  ...
  ADD CONSTRAINT `buku_ibfk_2` FOREIGN KEY (`id_kategori`) REFERENCES `kategori_buku` (`id_kategori`);
