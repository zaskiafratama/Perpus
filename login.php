                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                    <center><img src="assets/img/lgg.png" id="preview" width="30%" height="50%"></center>
                                        <?php
                                        ...
                                        ?>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <button class="btn btn-outline-info" type="submit" name="login" value="login">Login</button>
