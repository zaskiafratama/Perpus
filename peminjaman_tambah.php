    ...
    <div class="col-md-12">
        <form method= "post">
            ...
            if(isset($_POST['submit'])) {
                ...
                $query = mysqli_query($koneksi, "INSERT INTO peminjaman values ('','$id_user','$id_buku','$foto','$tanggal_peminjaman','$tanggal_pengembalian','$status_peminjaman')");
            ...
            <div class="row mb-5">
                <div class="col-md-8">Tanggal Peminjaman</div>
                <div class="coll-md-8">
        ...
        <div class="row mb-5">
                <div class="col-md-8">Status Peminjaman</div>
                <div class="coll-md-8">
